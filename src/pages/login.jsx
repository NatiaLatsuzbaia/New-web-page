  ...
  const [action, setAction] = useState('Sign Up');
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            window.alert('Something went wrong. Please try again.', setError );
    ...
    return (
        <React.Fragment>
                <div className='container-fluid'>
                    <h1 className="fs-1 p-5 text-center">The Sports Blog</h1>
                </div>

            <div className='container'>
                <div className='header'>
                    <div className='text fs-1 fw-semibold'>{action}</div>
                    <div className='underline rounded-4 mb-3'></div>
                </div>
                <form method='POST' onSubmit={handleSubmit}>
                    ...
                    <div className='submit-container justify-content-center'>
